 ...
 */
public class Lcd1602 extends I2CDevice {
     ...
     */
    public Lcd1602(Context pi4j, int rows, int columns){
     ...
     */
    public Lcd1602(Context pi4j, int rows, int columns, int device) {
